...
{
    public class UpdateStoreValidator : AbstractValidator<StoreDto>
    {
        private readonly BestBuyContext context;
        public UpdateStoreValidator(BestBuyContext context)
        {
            ...
            RuleFor(x => x.Name)
                ...
                .DependentRules(() =>
                {
                    ...
                    .Must((dto, name) => !context.Stores.Any(x => x.Name == name && x.Id != dto.Id))
            ...
            RuleFor(x => x.Email)
                ...
                .DependentRules(() =>
                {
                    ...
                    .Must((dto, email) => !context.Stores.Any(x => x.Email == email && x.Id != dto.Id))
